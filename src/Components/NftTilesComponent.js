                ...
                <li key={Math.random()} className="my-3">
                    <div className="shadow-lg rounded-lg cursor-pointer">
                      ...
                      <div className="flex-1 bg-white p-3 flex flex-col justify-between rounded-lg">
                          ...
                          <div className={`text-sm py-1 ${nft.imageUrl ? 'line-clamp-1' : 'line-clamp-11'}`}>
                              <pre title={nft.postText} className="whitespace-pre-wrap">{nft.postText}</pre>
                          </div>

                          <ul className="flex space-x-1 pt-1">
                              <li>
                      ...
                      <div className="text-indigo-100 bg-indigo-700 px-3 py-3 sm:px-3 rounded-b-lg">
                          <ul className="text-white">
                              ...
                              <li className="inline">
                                ...
                                {!nft.lowestHighestBidClout && !!nft.highestPricePaidClout && <div className="text-xs inline ml-1">Last {nft.highestPricePaidClout} <CloutIcon /></div>}
